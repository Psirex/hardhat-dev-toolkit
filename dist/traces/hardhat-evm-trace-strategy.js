...
exports.HardhatEvmTraceStrategy = void 0;
...
exports.HardhatEvmTraceStrategy = HardhatEvmTraceStrategy;
function getHardhatVM(provider) {
    const hardhatProvider = provider._hardhatProvider;
    const unwrappedProvider = unwrapProvider(hardhatProvider);
    const node = (0, lodash_1.get)(unwrappedProvider, "_node");
    if (!node) {
...
function unwrapProvider(provider) {
    ...
    do {
        ...
        unwrappedProvider = unwrappedProvider._wrapped;
    } while ((0, lodash_1.get)(unwrappedProvider, "_wrapped"));
